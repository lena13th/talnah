...
class NewsSearch extends News
{
    ...
    {
        return [
            [['news_id', 'published', 'related_event', 'related_sportbuilding'], 'integer'],
            [['title', 'short_description', 'content', 'date_event_start', 'date_event_end', 'image', 'date_public', 'updated_on'], 'safe'],
        ];
    }
