...
use yii\helpers\Url;
use app\modules\editable\Editable;

/* @var $this \yii\web\View */
/* @var $model \app\modules\comments\models\CommentModel */
...
<!--        </div>-->
        <div class="comment-details">
            <div class="comment-action-buttons">
                <?php if (Yii::$app->getUser()->can('admin') || $sessid === $model->sessionid ) : ?>
            ...
            <div class="comment-body">
                <?php if (Yii::$app->getModule('comment')->enableInlineEdit && Yii::$app->getUser()->can('admin') || $sessid == $model->sessionid): ?>
    ...
    <ul class="children">
        <?php foreach ($model->getChildren() as $children) : ?>
            <li class="comment" id="comment-<?php echo $children->id; ?>">
                <?php echo $this->render('_list', ['model' => $children, 'maxLevel' => $maxLevel, 'sessid' => $sessid]) ?>
            </li>
        <?php endforeach; ?>
    </ul>
<?php endif; ?>
