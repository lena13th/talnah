...
```php
php yii migrate --migrationPath=@app/modules/comments/migrations
```
...
```php
  'controllerMap' => [
      'comments' => 'app\modules\comments\controllers\ManageController',
      // Also you can override some controller properties in following way:
      'comments' => [
          'class' => 'app\modules\comments\controllers\ManageController',
          'searchClass' => [
              'class' => 'app\modules\comments\models\search\CommentSearch',
              'pageSize' => 25
          ],
...
<?php echo \app\modules\comments\widgets\Comment::widget([
    'model' => $model,
]); ?>
```
...
'modules' => [
    'comment' => [
        ...
        'controllerMap' => [
            'default' => [
                'class' => 'app\modules\comments\controllers\DefaultController',
